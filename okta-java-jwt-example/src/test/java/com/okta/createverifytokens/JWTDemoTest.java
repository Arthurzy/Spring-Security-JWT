...
//        StringBuilder tamperedJwt = new StringBuilder(jwt);
        StringBuilder tamperedJwt = new StringBuilder("eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJTT01FSUQxMjM0IiwiaWF0IjoxNjQyNDA4OTgwLCJzdWIiOiJBbmRyZXciLCJpc3MiOiJKV1QgRGVtbyIsImV4cCI6MTY0MjQwOTc4MH0.");
